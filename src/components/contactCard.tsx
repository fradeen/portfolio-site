...
export default function ContactCard({ mediaLink }: { mediaLink: SocialMediaLink }) {
    return (
        <div className={`w-full h-full min-w-80 max-w-screen-lg border-2 rounded-lg p-3 flex gap-3 justify-between items-center ring-black hover:ring-2 hover:bg-gradient-to-l hover:from-${mediaLink.accentColor}`} aria-labelledby={`${mediaLink.id}`}>
